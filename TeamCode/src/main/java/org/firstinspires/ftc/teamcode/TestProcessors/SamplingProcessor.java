...
@Autonomous(group="Autonomous", name="SamplingProcessor")
public class SamplingProcessor extends LinearOpMode implements RobotInterface {
    ...
    public SamplingProcessor(boolean Depo) {
        this.depo = Depo;
    }
    ...
    public void runOpMode() {
        ...
        autonomous_processors.add( new Sampling_Auto_Processor(this));
