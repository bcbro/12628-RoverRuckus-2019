...
@Autonomous(group="Autonomous", name="CraterMovement")
public class CraterMovement extends LinearOpMode implements RobotInterface {
    ...
    public CraterMovement(boolean Depo) {
        this.depo = Depo;
    }

    public CraterMovement() {
    ...
    public void runOpMode() {
        ...
        autonomous_processors.add( new Sampling_to_Depo_Auto_Processor(this, false));
